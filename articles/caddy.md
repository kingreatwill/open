...
# docker run -d --restart=always --network host     -v /data/dockerv/caddy/srv:/srv     -v /data/dockerv/caddy/data:/data     -v /data/dockerv/caddy/log:/log     -v /data/dockerv/caddy/config:/config     -v /data/dockerv/caddy/Caddyfile:/etc/caddy/Caddyfile     --name caddy kingreatwill/caddy:v2.11.1
```
Caddyfile
```
